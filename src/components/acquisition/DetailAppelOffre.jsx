    ...
    return ( 
        <div className="flex flex-col grow space-y-2 p-2 overflow-y-auto">
            ...
            <div className="flex flex-col border-[1px] space-2 p-2 ">
                ...
                <div className="flex space-x-2">
                    <span className="font-semibold text-zinc-600">Date limite reponse:</span>
                    <span className="">sdlfjdkjfkd</span>
                </div>
                <div className="flex space-x-2">
                    <span className="font-semibold text-zinc-600">Date de livraison au plus tard:</span>
                    <span className="">sdlfjdkjfkd</span>
                </div>
                <div className="flex space-x-2">
                ...
                <div className="flex space-x-2">
                    <span className="font-semibold text-zinc-600">Réponses Associés:</span>
                    <span className="">reference</span>
                </div>
            </div>
            {/* détails bordereau */}
