...
const UpdateModal = ({context}) => {
    return ( 
        <div  className="flex items-center w-full pt-[3em] border-2 border-zinc-600  h-full bg-zinc-900  bg-opacity-50 absolute top-0 left-0">
            <div className="m-auto flex flex-col w-2/3 h-5/6 overflow-y-auto bg-zinc-200 p-1 rounded-lg">
                <div className="flex justify-end shadow-lg  items-center p-2">
                        <svg 
                ...
                <ModificationAppelOffre idAppel={context.idAppel}/>
            </div>
        </div>
     );
}
