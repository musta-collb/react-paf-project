...
const Offre = ({offre}) => {
    ...
    return ( 
        <div className="flex flex-col bg-white shadow-lg rounded p-1">
                ...
                <div className="flex  p-1 space-x-2">
                    <p>Fornisseur:</p>
                    <span class="bg-blue-100 text-blue-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800">{offre.fournisseur}</span>
                </div>
